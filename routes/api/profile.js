...
router.get(
  ...
  (req, res) => {
    ...
    Profile.findOne({ user: req.user.id })
      .populate("user", ["name", "avatar"]) // Populating the name and avatar from the users as user in the profile
      .then(profile => {
        if (!profile) {
...
// @desc    Returns every user profiles
// @access  Public
...
// @desc    Returns user profile using the handle
// @access  Public
...
// @desc    Returns user profile using the user_id
// @access  Public
